...
///--Menus and Programs---///
static const char *menucmd[]   = { "rofi2bwm", NULL };
static const char *gmrun[]     = { "goback", NULL };
static const char *screen1[]     = { "goto1", NULL };
static const char *screen2[]     = { "goto2", NULL };
static const char *screen3[]     = { "goto3", NULL };
...
static key keys[] = {
    ...
    {  MOD |CONTROL,      XK_1,          start,             {.com = screen1}},
    {  MOD |CONTROL,      XK_2,          start,             {.com = screen2}},
    {  MOD |CONTROL,      XK_3,          start,             {.com = screen3}},
